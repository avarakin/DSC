...
// Calibration procedure is described here:
//https://youtu.be/Bw0WuAyGsnY
...
Coordinates SensorBNO055::getCoordinates()
{
    ...
    return Coordinates(event.orientation.x*100,event.orientation.y*100);
